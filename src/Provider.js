...
class Provider extends Component {
  state = {
      ...
      fetch(url, form)
        ...
        .then((response) => {
          ...
          if(response.result === 1){
            ...
            if(response.board[0] === "X" && response.board[1] === "X" && response.board[2] === "X"){
              this.setState({line: "one"})
            }
            else if(response.board[3] === "X" && response.board[4] === "X" && response.board[5] === "X"){
              this.setState({line: "two"})
            }
            else if(response.board[6] === "X" && response.board[7] === "X" && response.board[8] === "X"){
              this.setState({line: "three"})
            }
            else if(response.board[0] === "X" && response.board[3] === "X" && response.board[6] === "X"){
              this.setState({line: "four"})
            }
            else if(response.board[1] === "X" && response.board[4] === "X" && response.board[7] === "X"){
              this.setState({line: "five"})
            }
            else if(response.board[2] === "X" && response.board[5] === "X" && response.board[8] === "X"){
              this.setState({line: "six"})
            }
            else if(response.board[0] === "X" && response.board[4] === "X" && response.board[8] === "X"){
              this.setState({line: "seven"})
            }
            else if(response.board[2] === "X" && response.board[4] === "X" && response.board[6] === "X"){
              this.setState({line: "eight"})
            }
          }
          else if(response.result === 2){
            this.setState({gameResult: "Computer win"})
            if(response.board[0] === "O" && response.board[1] === "O" && response.board[2] === "O"){
              this.setState({line: "one"})
            }
            else if(response.board[3] === "O" && response.board[4] === "O" && response.board[5] === "O"){
              this.setState({line: "two"})
            }
            else if(response.board[6] === "O" && response.board[7] === "O" && response.board[8] === "O"){
              this.setState({line: "three"})
            }
            else if(response.board[0] === "O" && response.board[3] === "O" && response.board[6] === "O"){
              this.setState({line: "four"})
            }
            else if(response.board[1] === "O" && response.board[4] === "O" && response.board[7] === "O"){
              this.setState({line: "five"})
            }
            else if(response.board[2] === "O" && response.board[5] === "O" && response.board[8] === "O"){
              this.setState({line: "six"})
            }
            else if(response.board[0] === "O" && response.board[4] === "O" && response.board[8] === "O"){
              this.setState({line: "seven"})
            }
            else if(response.board[2] === "O" && response.board[4] === "O" && response.board[6] === "O"){
              this.setState({line: "eight"})
            }
          }
    ...
    play: (e) => {
      ...
      if(this.state.gamePlayed !== false  && this.state.gamePlayed[num-1] !== '-'){
